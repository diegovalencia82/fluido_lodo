...
c     &     du(nmax), ds(nmax), drho(nmax), av(dim, nmax)
...
c      write(*,*)'11'
c      call neighboring_searchr(rdomain,mspace,ntype,npairs,pairs,nfilas,
c     +     mrij,mxij,mvij,mvxij,itimestep)
          
      call neighboring_searchx(rdomain,mspace,ntype,npairs,pairs,nfilas,
     +     mrij,mxij,mvij,mvxij,itimestep)
