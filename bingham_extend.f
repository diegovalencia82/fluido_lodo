      ...
      subroutine bingham_extend(mspace,ntype,npairs,pairs,nfilas,w,dwdx)
...
! mspace(10,i) = p
      ...
      do i=1,ntype(1)-ntype(2)
         ...
         mspace(21,i) = 0.0
         mspace(22,i) = 0.0
         modelb = mspace(10,i)*(tan(phi)-1.)+c 
         pirhoi = modelb/mspace(9,i)**2
         sumx = 0
         sumy = 0
         sumz = 0
c         write(*,*)i,'sph presion----',mspace(2,i),mspace(4,i)
         do j=1,nfilas(i)
            modelb = mspace(10,pairs(j,i))*(tan(phi)-1.)+c 
            pjrhoj = modelb/mspace(9,pairs(j,i))**2
